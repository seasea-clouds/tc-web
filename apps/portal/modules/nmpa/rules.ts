...
const COUNTRIES: Record<string, any> = {"France": {"diff": "easy", "notes": t("nmpa_country_france")}, "Japan": {"diff": "easy", "notes": t("nmpa_country_japan")}, "South Korea": {"diff": "easy", "notes": "K-beauty popular. Fastest NMPA processing history."}, "USA": {"diff": "moderate", "notes": "US brand premium positioning. Standard processing."}};

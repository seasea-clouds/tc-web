...
import { Footer, SearchProvider, CookieConsent, ActionDock, AuthProvider, TradeTranslationProvider, OrganizationJsonLd, buildAlternates, sharedOpenGraph, sharedTwitter, AutoBreadcrumb, Favicon } from '@trade/ui';

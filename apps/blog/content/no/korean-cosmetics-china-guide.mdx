...
– Positivlisten bestemmer kvalifiserte produktkategorier
...
| | Vanlig kosmetikk | Spesiell kosmetikk |
|---|---|---|
| **Behandle** | Varslingsarkivering | Registrering |
| **Anmeldelsestype** | Dokumentar gjennomgang | Innholdsmessig teknisk gjennomgang |
| **Tidslinje** | Varierer | Varierer (betydelig lengre) |
...
| **Dyretesting** | Potensielt unntatt (med GMP + sikkerhetsvurdering) | Generelt nødvendig |
...
- Et dedikert merke for barnekosmetikk må vises på emballasjen
...
### 6. Kan jeg bruke samme formel som jeg selger i Korea?
...
### 9. Kan jeg sende inn ett produkt, men selge flere varianter?

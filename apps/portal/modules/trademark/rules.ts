...
export function checkTrademark(input: any, locale?: string): any {
  ...
  return {
    ...
    regulations: [
      { name: t("trademark_law_of_china"), number: t("tmReg_revision_number"), effectiveDate: t("date_nov1_2019"), issuingAuthority: t("cnipa_npc"), relevance: "primary", description: t("first_to_file_system_art_32_prevents_bad_faith_fil") },
      ...
      { name: t("customs_ip_protection_regulations"), number: t("state_council_decree_395"), effectiveDate: t("date_mar1_2004"), issuingAuthority: "GACC", relevance: "secondary", description: t("border_enforcement_customs_can_detain_suspected_co") },
    ],

...
date: "2026-07-16"
category: "Cosmetics"
excerpt: "Çin'e giren Koreli kozmetik markaları kritik sınıflandırma kararlarıyla karşı karşıyadır: Şampuanınız veya saç derisi bakım ürününüz sıradan mı yoksa özel bir kozmetik mi?"
references:
...
Kore kozmetik ürünleri uzun süredir Çinli tüketiciler arasında güçlü bir üne sahip.

Ancak Koreli markaların (özellikle küçük ve orta ölçekli şirketlerin) **genel ticari ithalat** rotası üzerinden Çin'e girmeleri, NMPA'nın Kozmetik Denetleme ve Yönetim Yönetmeliği (CSAR, 2021'den itibaren geçerli) kapsamındaki kozmetik düzenleme çerçevesinde gezinmeyi gerektirir.

Yol, sınır ötesi e-ticaretten (CBEC) önemli ölçüde farklıdır ve birçok marka, başvuru zaman çizelgesini, maliyetini ve uyumluluk yükümlülüklerini belirleyen sınıflandırma kararları karşısında şaşırır.
...
## Genel Ticaret ve Sınır Ötesi E-Ticaret Karşılaştırması
...
### Sınır Ötesi E-Ticaret (跨境电商 / CBEC)
...
- Pozitif Liste (《跨境电子商务零售进口商品清单》) uygun ürün kategorilerini belirler

> **Halihazırda Çin'de faaliyet gösteren** ve hem çevrimiçi e-ticaret hem de çevrimdışı perakende satış yoluyla satış yapmayı planlayan Koreli markalar için — tam NMPA uyumluluğuyla genel ticaret uygun yoldur.

## Sınıflandırma: Ürününüz Sıradan mı yoksa Özel Kozmetik mi?

Bu, herhangi bir kozmetik ithalat projesi için **en önemli sorudur**.
...
5. Saç dökülmesini önleyici (防脱发)
...
**Şampuan (洗发精/洗发水)** — Standart bir şampuan **her zaman sıradan bir kozmetiktir**.

Bununla birlikte, bir şampuan ürünü **saç dökülmesini veya saç büyümesini önleyici iddialarda** bulunuyorsa, bu özel kozmetik alanına girer.

**Saç derisi bakımı / saç derisi özü (头皮水/头皮护理产品)** — Bu ürün türü gri bir alanı kaplar:

- Yalnızca saç derisini **nemlendirici, besleyici veya yatıştırıcı** olarak pazarlanıyorsa, sıradan bir kozmetiktir

- **saç büyümesini teşvik edici** (育发/生发) veya **saç dökülmesini önleyici** (防脱发) iddialarıyla pazarlanıyorsa — kayıt gerektiren özel bir kozmetiktir

- **kafa derisi sağlığı bakımı** (头皮养护), **kepek kontrolü** (去屑) veya **yağ dengesi** (控油) ile pazarlanıyorsa bunlar, kozmetik açıdan etkili hiçbir özel kelime kullanılmadığı sürece sıradan kalabilecek genel iddialardır.

**Önemli bilgi:** Düzenleme sınıflandırması, yalnızca ürün formülasyonuna değil, **yaptığınız iddialara** bağlıdır.

Aynı bileşenlere sahip bir saç derisi özü, iddiaların genel saç derisi bakımıyla sınırlı olması durumunda sıradan kozmetik olarak sunulabilir veya saç büyümesi iddiaları eklendiğinde özel kayıt gerektirebilir.
...
## Bebek ve Gebelik İddialarına İlişkin Özel Hususlar

Müşterinin ürünleri **bebekler, çocuklar ve hamile kadınlar** için uygun olup, **"katkı maddesi içermez"** (无添加) konumuyla tanımlanmaktadır.
...
- Paket üzerinde özel bir Çocuk Kozmetik etiketi işareti (儿童化妆品标志 — "小金盾" simgesi) görünmelidir
...
"Katkı maddesi yok" (无添加) iddiası Kore kozmetik pazarlamasında popülerdir ancak CSAR kapsamında **düzenlenmiş bir iddia kategorisi değildir**.
...
1. **Ürün Formülü (完整配方)** — Konsantrasyonları ve Çince INCI adlarını içeren eksiksiz içerik listesi

2. **Ürün Güvenliği Değerlendirme Raporu (产品安全评估报告)** — Nitelikli bir değerlendiriciden zorunlu tam güvenlik değerlendirmesi

3. **Üretim Süreci Açıklaması (生产工艺简述)**

4. **Ürün Kalite Standardı (产品质量标准)**

5. **Ürün Etiketi ve Ambalaj Örnekleri (产品标签及包装样稿)**

6. **Ücretsiz Satış Sertifikası / Sağlık Sertifikası (自由销售证明)** — Kore sağlık otoriteleri (MFDS) tarafından verilmiştir.

7. **GMP Sertifikası veya Üretim Lisansı (生产规范证明)**

8. **Vekaletname / Yetki Mektubu (授权委托书)** — Çinli sorumlu kişinin atanması

9. **Sorumlu Kişinin İşletme Lisansı (境内责任人营业执照)**

10. **Ürün Güvenliğiyle İlgili Bilgiler (产品安全相关资料)** — MSDS, stabilite testi raporları vb. dahil.
...
> **Fiyat notu:** Başvuru maliyetleri, ürün kategorisine, çeşit sayısına, test gereksinimlerine ve çocuk kozmetik değerlendirmesinin gerekli olup olmadığına bağlı olarak önemli ölçüde değişiklik gösterir.
...
2. **Etkililik Test Raporu (功效评价报告)** — NMPA onaylı bir Çin laboratuvarından

3. **Dermatolojik Klinik Test Raporu (人体安全性检验报告)**

4. **Ürün Toksikolojik Test Raporu (毒理学试验报告)** — Hayvan testleri genellikle gereklidir

5. **Stabilite Testi Raporu (稳定性试验报告)**

6. **Ambalaj Malzemesi Uyumluluk Testi (包装材料相容性检测)**
...
**Toplam zaman çizelgesi:** Önemli ölçüde değişiklik gösterir.

## Kore Markaları: Özel Hususlar

### MFDS ve NMPA Standartları

Kore kozmetik ürünleri MFDS (Gıda ve İlaç Güvenliği Bakanlığı) denetimi altında üretilmektedir.
...
- **Test standartları:** NMPA, CNAS onaylı Çin laboratuvarlarında test yapılmasını gerektirir;

- **Etiket gereklilikleri:** Kore ambalajlarında genellikle yalnızca Korece metin kullanılır;

### MFDS'den Ücretsiz Satış Sertifikası

Koreli marka sahiplerinin Kore Gıda ve İlaç Güvenliği Bakanlığı'ndan (MFDS) **Ücretsiz Satış Sertifikası (자유판매증명서)** alması gerekir.
...
Kore'de kozmetik ürün adları, Kore Kozmetik Endüstrisi Birliği'ne (KCIA) veya doğrudan MFDS'ye kayıtlıdır.
...
1. **Hemen dosyalayın** — Sıradan kozmetik dosyalama daha hızlı yoldur.
...
1. **Daha uzun bir zaman çizelgesi için bütçe** — Özel kozmetiklerin tescili oldukça uzun sürer;
...
**Evet.** Kozmetik ürünlerini genel ticaret yoluyla (sınır ötesi e-ticaret değil) ithal ediyorsanız, her ürünün ithalattan önce NMPA'ya dosyalanması (sıradan kozmetikler) veya kaydedilmesi (özel kozmetikler) gerekir.

Zaten bir Çin kuruluşunuz varsa ve hem çevrimiçi hem de çevrimdışı kanallar aracılığıyla satış yapmayı planlıyorsanız, tam NMPA uyumluluğuyla genel ticaret gerekli yoldur.

### 2. NMPA başvurusu yapmadan sınır ötesi e-ticaret yoluyla satış yapabilir miyim?

**Evet, alternatif olarak.** Tmall Global ve JD Worldwide gibi sınır ötesi e-ticaret (CBEC) platformları, ürünlerin Pozitif Listede olması koşuluyla NMPA dosyası olmadan kozmetik satışlarına izin verir.

CBEC, tam NMPA uyumluluğu hazırlanırken bir pazar testi kanalı olarak veya çevrimdışı dağıtımı planlamıyorsanız birincil kanalınız olarak kullanılabilir.

### 3. Şampuan sıradan mı yoksa özel bir kozmetik midir?

**Standart bir şampuan sıradan bir kozmetiktir.** Temel işlevi temizleme olan şampuanlar, saç derisi bakımı veya saçı besleme iddiası içermelerine bakılmaksızın sıradan kozmetiklerin kapsamına girer.

Bununla birlikte, bir şampuan ürünü açıkça **saç dökülmesini önleyici (防脱发)** veya **saç büyümesini teşvik edici (育发/生发)** iddiasında bulunuyorsa, bu ürün özel kozmetik alanına girer ve tam kayıt gerektirir.

### 4. Peki ya saç derisi bakım ürünleri — nereye düşerler?
...
Tam olarak aynı formülasyon sıradan olarak sunulabilir veya özel olarak kaydedilebilir; bu, onun hakkında ne söylediğinize bağlıdır.
...
**Zorunlu değil.** Kore'de MFDS tarafından onaylanan bazı bileşenler Çin'de yasaklanmış olabilir veya farklı konsantrasyon sınırlarına tabi olabilir.

Ek olarak, Kore test raporları güvenlik değerlendirmenizi destekleyebilirken, NMPA genellikle son başvuru veya kayıt için CNAS onaylı Çin laboratuvarlarında test yapılmasını gerektirir.
...
### 8. Dosyalama sürecini başlatmak için hangi belgelere ihtiyacım var?
...
**Her varyant genellikle ayrı bir dosyalama gerektirir.** Ürünler formülasyon, koku, renk veya aktif madde konsantrasyonu bakımından farklılık gösteriyorsa, ayrı NMPA başvuruları gerektiren ayrı SKU'lar olarak değerlendirilirler.

Bununla birlikte, yalnızca ambalaj boyutunda farklılık gösteren ürünler (örneğin, aynı formülün 50 ml ve 200 ml'lik versiyonları) belirli koşullar altında bir dosyalamayı paylaşabilir.

### 10. Kozmetik ürünlerini dosyalamak için Çinli bir kuruluşa ihtiyacım var mı?

**Evet.** Çin'e ithal edilen her kozmetik ürünün, Çin'de kozmetikle ilgili iş kapsamına sahip kayıtlı bir tüzel kişilik olan Çinli bir yerel sorumlu kişisi olmalıdır.

Sorumlu kişi, ürün güvenliğinden yasal olarak sorumludur ve tüm NMPA iletişimlerini yönetir.

/**
 * Admin-side PDF generator (on-demand, no R2 needed)
 * Pure function — only depends on pdf-lib (shared monorepo dep)
 */
...
export async function generateReportPdf(data: AdminPdfData): Promise<Uint8Array> {

---
title: "Der Vorteil der Erstanmeldung bei der Markenregistrierung in China"
slug: "china-trademark-registration"
date: "2018-07-05"
category: "Brand Protection"
excerpt: "In China gilt das Prinzip der Erstanmeldung. Wer seine Marke nicht registriert, dem kommt ein anderer zuvor. Erfahren Sie, warum die frühzeitige Markenregistrierung der wichtigste Schritt für jedes Unternehmen ist, das in den chinesischen Markt einsteigt."
references:
...
Für deutsche Marken gilt das in besonderem Maße: Eine deutsche Marke beim DPMA oder eine Unionsmarke beim EUIPO schützt Sie in China nicht. Nur die Registrierung beim CNIPA zählt. Markenpiraten warten oft gezielt darauf, dass bekannte deutsche Marken aus Maschinenbau, Automobilzulieferung oder Konsumgütern den chinesischen Markt betreten, ohne vorher zu registrieren.
...
Das unterscheidet China grundlegend vom deutschen Markenrecht: In Deutschland entsteht Markenschutz durch Registrierung beim DPMA, wobei auch eine geschäftliche Nutzung Rechte begründen kann. In China entscheidet allein der Zeitpunkt der Anmeldung. Eine frühere Nutzung Ihrer Marke in Deutschland oder der EU begründet dort keine Rechte.
...
Zusätzlich empfiehlt sich für deutsche Exporteure die **Zollregistrierung geistigen Eigentums** beim chinesischen Zoll: Damit kann die Einfuhr von Fälschungen bereits an der Grenze gestoppt werden, bevor die Ware den Markt erreicht. Fälschungen deutscher Marken auf Alibaba, Tmall oder JD können Sie mit einer eingetragenen chinesischen Marke direkt melden und entfernen lassen.
...
Gerade mittelständische deutsche Unternehmen scheuen zunächst die Kosten einer CNIPA-Anmeldung und zahlen später oft ein Vielfaches, um ihre Marke von einem Markenpiraten zurückzukaufen. Eine einzige Anmeldung ist in der Regel deutlich günstiger als ein Rechtsstreit oder ein Rückkauf in China.
...
Deutsche Markeninhaber können eine bestehende Marke über das Madrid-System auf China ausdehnen: Eine internationale Registrierung über das DPMA oder EUIPO mit Benennung Chinas genügt. Das ist kostengünstig, wenn Sie ohnehin in mehreren Ländern schützen möchten. Für den Fokus auf China ist die direkte Anmeldung beim CNIPA jedoch oft robuster, da die Waren- und Dienstleistungsliste flexibler an den chinesischen Markt angepasst werden kann.
...
Wir bieten umfassende Markenschutzdienste: Markensuche und -freigabe, Entwicklung chinesischer Markennamen, Strategie zur Einreichung mehrerer Klassen, CNIPA-Antragsverwaltung und laufende Markenüberwachung. Dazu gehört auch die Zollregistrierung geistigen Eigentums, damit deutsche Marken an der chinesischen Grenze gegen Fälschungen geschützt sind.

[Kontaktieren Sie uns](/de/packages/) für eine kostenlose Markenschutzbewertung.

...
import { Footer, SearchProvider, CookieConsent, ActionDock, TradeTranslationProvider, OrganizationJsonLd, sharedOpenGraph, sharedTwitter, AuthProvider, buildAlternates, Favicon, GeoMeta } from '@trade/ui';

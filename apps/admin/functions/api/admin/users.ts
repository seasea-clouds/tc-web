 ...
 * GET  /api/admin/users?id=xxx     — single user detail
 * POST /api/admin/users?id=xxx     — enable/disable user (body: { status })
 */
...
export async function onRequest(context: { request: Request; env: Env }) {
  ...
  // ── POST /api/admin/users?id=xxx — enable/disable user ──
  if (context.request.method === "POST" && userId) {
  ...
  // ── GET /api/admin/users?id=xxx — single user detail ──
  if (context.request.method === "GET" && userId) {

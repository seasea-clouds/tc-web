...
const LEGIT_ENGLISH = new Set([
  ...
  'Contact us',
  'English accepted. Chinese translation for labels.',
  'English accepted. Chinese translation for labels required.',
  'EU framework. MFN rates.',
  'GB/T 35914-2018',
  'Label Fields',
  'National Food Safety Standard — General Rules for Nutrition Labeling of Prepackaged Foods. Mandatory',
  ...
  'South Asia',
  'South Korea',
  'Spanish documents need Chinese translation.',
  'Squatter Risk',
  'Stability testing',
  'Sulfur dioxide',
  'Tmall Global',
  // ─── JSON-LD Schema types ────────────────────────────────────────
  "Organization', name: 'SinoTrade Compliance",
  "ProfessionalService', 'LocalBusiness",
  "Industry', '",
  "Name', '",
  "Rating', ratingValue: item.rating.toString(), bestRating: '5",
  "English', 'Chinese",
  "ProductName', 'Ingredients', 'NetContent', 'Nutrition', 'Allergens', 'DateMarking', 'CountryOfOrigin",
  // ─── Icon name mappings (icon component props) ────────────────────
  "Truck', serviceKey: 'gacc",
  "Tag', serviceKey: 'label",
  "Shield', serviceKey: 'ccc",
  "Sparkles', serviceKey: 'cosmetics",
  "ShoppingCart', serviceKey: 'ecommerce",
  // ─── Blog UI ─────────────────────────────────────────────────────
  'Post Not Found',
  // ─── Contact form ────────────────────────────────────────────────
  'New Inquiry \u2014 SinoTrade Website',
  // ─── Country names ───────────────────────────────────────────────
  'Argentina', 'Australia', 'Colombia', 'Ethiopia', 'Indonesia', 'Malaysia', 'Netherlands', 'Thailand',
  // ─── Standard/technical terms ────────────────────────────────────
  'Biocompatibility ISO 10993',
  'Chemical GB 6675.4',
  'Mechanical GB 6675.2',
  'Flammability GB 6675.3',
  'Safety GB 4706.1',
  'Safety GB 4943.1',
  'Safety GB 4943.1-2022',
  'Safety GB 7000.1',
  'Safety GB 9706.1',
  'Harmonics GB 17625.1',
  'Phthalates',
  'Wireless SRRC',
  'Energy Efficiency Label',
  'Energy efficiency',
  'Energy label registration',
  'Product-specific GB 4706.xx',
  'Product Formula (Full INCI)',
  'User Manual (Chinese)',
  'Key Component List',

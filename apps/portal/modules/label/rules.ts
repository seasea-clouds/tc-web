...
export function checkLabel(input: LabelInput, locale?: string): LabelResult {
  ...
  return {
    ...
    tariffInfo: { mfnRate: "5-20%", vatRate: "9-13%", consumptionTax: "N/A", ftaRate: null, totalTaxBurden: t("varies_by_product") },
    regulations: [
    ...
    requiredDocuments: [t("original_label_artwork"), "Chinese Label Design", t("nutrition_test_report"), "Certificate of Free Sale", t("ingredients_declaration")],
    ...
    labTests: ["Nutritional analysis", t("additive_verification"), "Microbiological"],
    viability: t('labelViability'),
    detailedTimeline: t("label_review_3_5_working_days_design_5_7_working_d"),
    labelGuide: {
      requiredItems: [
        { field: "Product Name", requirement: t("accurate_reflection_of_product_nature_standardized"), commonMistake: t("fanciful_names_without_standard_name") },
        { field: "Ingredients List", requirement: t("descending_order_by_weight_additives_with_gb_2760_"), commonMistake: t("missing_additive_codes_or_wrong_order") },
        { field: "Net Content", requirement: t("metric_units_g_ml_draining_weight_if_needed"), commonMistake: t("imperial_units") },
        ...
        { field: "Country of Origin", requirement: "Clearly marked.", commonMistake: t("vague_description") },
        { field: t("date_best_before"), requirement: t("dd_mm_yyyy_or_yyyy_mm_dd"), commonMistake: t("mm_dd_yyyy_format") },
        { field: "Storage Conditions", requirement: t("clear_storage_instructions"), commonMistake: t("generic_statements") },
        { field: "Nutrition Panel", requirement: t("energy_kj_protein_fat_carbs_sodium_nrv"), commonMistake: t("using_kcal_missing_nrv") },
        { field: t("additive_codes"), requirement: t("gb_2760_codes_e330_ins_330"), commonMistake: t("trade_names") },
        { field: "Allergens", requirement: t("milk_eggs_fish_crustacea_peanuts_soy_wheat_tree_nu"), commonMistake: t("not_declared") },
        { field: t("import_record"), requirement: t("ciq_number_after_clearance"), commonMistake: "Blank" },
      ],
      gb7718Highlights: [t("all_text_must_be_chinese_foreign_supplementary_onl"), "Font ≥ 1.8mm.", t("gmo_must_be_labeled"), t("irradiated_declared"), t("trans_fat_if_0_3g_100g")],
      gb28050Highlights: [t("energy_in_kj_primary"), t("protein_fat_carbs_sodium_mandatory"), t("nrv_per_appendix_a"), t("format_must_match_standard"), "Tolerance ≤120% energy."],
    },
    timelinePhases: [
      ...
      { phase: "Chinese Label Design", duration: "5-7 working days", description: t("create_compliant_chinese_label_artwork"), responsible: "SinoTrade", dependencies: [t("label_review_complete")] },
    ...
    postApprovalObligations: [
      { item: t("label_update_monitoring"), frequency: "Ongoing", description: t("track_gb_7718_28050_revisions") },
      { item: t("formula_change_re_label"), frequency: "When applicable", description: t("new_formula_new_label_compliance_check") },
    ],
    postApproval: [
  ...
  nutritionGuide: {
    mandatoryFields: [t("energy_kj"), "Protein", "Fat", "Carbohydrate", "Sodium"],

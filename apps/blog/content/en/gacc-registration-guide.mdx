...
excerpt: "Everything food exporters need to know about GACC Decrees 248 and 249, from understanding the requirements to completing your CIFER registration and staying compliant."
references:
...
- Recall and traceability requirements — Importers must maintain batch-level traceability records and implement recall procedures for non-compliant products
...
6. **Veterinary or phytosanitary certificates** — Required for animal-derived and plant products in the 18 high-risk categories; issued by your country's competent authority
7. **Product labels** — Current labels for each product SKU

### Step 3: Submit Through the Appropriate Channel

For **18-category products** , submit your application through your national competent authority. They review and recommend qualifying facilities to GACC. This government-to-government channel typically takes **2-6 months** and is mandatory for high-risk products, so factor it into your market entry timeline.

For **non-18-category products** , you can register directly through the CIFER online system (available at cifer.singlewindow.cn, operated by GACC). The process is faster and more straightforward — typically **2-4 weeks** — with timing varying depending on product category and application completeness.
...
GACC registrations are valid for **5 years** . Renewal applications must be submitted **3-6 months in advance of expiration** . Missing the renewal deadline means your products can no longer enter China until the registration is renewed.
...
- **Label compliance monitoring** — Chinese labeling standards (GB 7718) are updated periodically; the 2025 revisions (GB 7718-2025 for general food labeling and GB 28050-2025 for nutrition labeling) introduce stricter requirements. Ensure your labels remain compliant with the current editions

      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        {step === "form" && (
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 space-y-5">
            ...
            <h1 className="text-2xl font-bold text-primary-navy">{t('crossborderTitle')}</h1>
            ...
            <div>
              ...
              <input
                ...
                minLength={2}
                placeholder={t("crossborderProductNamePlaceholder")}
                required
              />
            </div>
            <div>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <div className="bg-gray-50 rounded-lg p-3"><p className="text-xs text-gray-500">{t('resultCategory')}</p><p className="text-sm font-semibold mt-0.5">{t(`catCb_${input["category"]}`) || input["category"]}</p></div>
              </div>

...
export function checkCcc(input: any, locale?: string): any {
  ...
  return {
    ...
    regulations: [{"name": t("cnca_ccc_implementation_rules"), "number": "CNCA 00C-001:2023", "issuingAuthority": "CNCA/SAMR", "relevance": "primary", "effectiveDate": t("documentSeeLabel"), "description": t("ccc_certification_procedures_application_testing_f")}, {"name": t("ccc_product_catalogue"), "number": "CNCA 2023 Announcement", "issuingAuthority": "CNCA", "relevance": "primary", "effectiveDate": t("documentSeeLabel"), "description": t("products_subject_to_mandatory_ccc_certification_17")}, {"name": "GB 4943.1-2022", "number": "GB 4943.1-2022", "issuingAuthority": t("nhc_cnca"), "relevance": "secondary", "effectiveDate": t("documentSeeLabel"), "description": t("safety_of_it_equipment_mandatory_for_electronics_c")}, {"name": "GB 4706.1-2005", "number": "GB 4706.1-2005 + 30 sub-standards", "issuingAuthority": "CNCA", "relevance": "secondary", "effectiveDate": t("documentSeeLabel"), "description": t("safety_of_household_appliances_each_product_type_h")}, {"name": "GB 6675 Series", "number": "GB 6675.1-.4:2014", "issuingAuthority": "CNCA/SAMR", "relevance": "secondary", "effectiveDate": t("documentSeeLabel"), "description": t("toy_safety_mechanical_flammability_chemical_migrat")}, {"name": "GB 17625.1-2022", "number": "GB 17625.1-2022", "issuingAuthority": "CNCA", "relevance": "secondary", "effectiveDate": t("documentSeeLabel"), "description": t("emc_harmonic_current_emissions")}, {"name": t("china_energy_label"), "number": t("ndrc_mofcom_2020"), "issuingAuthority": "NDRC", "relevance": "secondary", "effectiveDate": t("documentSeeLabel"), "description": t("mandatory_energy_efficiency_labeling_for_specified")}, {"name": t("china_rohs_2"), "number": t("miit_order_32_2016"), "issuingAuthority": "MIIT", "relevance": "secondary", "effectiveDate": t("documentSeeLabel"), "description": t("hazardous_substances_in_electronic_products")}],
    ...
    horizonScan: [{ topic: t("cccHorizon_iot_topic"), impact: "high", timeframe: t("cccHorizon_iot_timeframe"), description: t("cccHorizon_iot_desc"), actionRequired: true }, { topic: t("cccHorizon_gbRev_topic"), impact: "medium", timeframe: t("cccHorizon_gbRev_timeframe"), description: t("cccHorizon_gbRev_desc"), actionRequired: true }, { topic: t("cccHorizon_cbDigital_topic"), impact: "low", timeframe: t("cccHorizon_cbDigital_timeframe"), description: t("cccHorizon_cbDigital_desc"), actionRequired: false }],

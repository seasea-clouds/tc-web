...
export function getGlossary(module: string, locale?: string): { term: string; def: string }[] {
  ...
  var gMap: Record<string, { term: string; def: string }[]> = {
    ...
    "Chinese Label Compliance": [
      ...
      {term: t('labelGlossary_foodSafetyLawTerm'), def: t('labelGlossary_foodSafetyLaw')},
      {term: t('labelGlossary_allergenTerm'), def: t('labelGlossary_allergen')},
    ...
    "Cosmetics Filing (NMPA)": [
      ...
      {term: t('nmpaGlossary_ordinaryTerm'), def: t('nmpaGlossary_ordinary')},
      {term: t('nmpaGlossary_specialTerm'), def: t('nmpaGlossary_special')},
    ...
    "Cross-Border E-commerce": [
      ...
      {term: t('cbGlossary_positiveListTerm'), def: t('cbGlossary_positiveList')},
      {term: t('cbGlossary_3docTerm'), def: t('cbGlossary_3doc')},
    ...
    "Brand Protection": [
      ...
      {term: t('tmGlossary_firstToFileTerm'), def: t('tmGlossary_firstToFile')},
      {term: "Nice Classification", def: t('tmGlossary_niceClass')},
      {term: "Madrid System", def: t('tmGlossary_madrid')},
      {term: t('tmGlossary_customsRecordalTerm'), def: t('tmGlossary_customsRecordal')},
      {term: t('tmGlossary_squattingTerm'), def: t('tmGlossary_squatting')},
      {term: t('tmGlossary_oppositionTerm'), def: t('tmGlossary_opposition')},

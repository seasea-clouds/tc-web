...
function getCATEGORY_PROFILES(t: (key: string) => string): Record<GaccCategory, CategoryProfile> {
  ...
  alcohol: {
    ...
    hsRange: "2203-2208",
    isHighRisk: false,
    riskReason: t("gaccProfile_alcohol_riskReason"),
    ciqCode: "102",
    chinaTariffRate: "5-10% (MFN)", 
    vatRate: "13%",
    consumptionTax: t("gaccConsumTax_alcohol"),
    gaccTimelineLow: "4-6 weeks",
    gaccTimelineHigh: "8-12 weeks",
    labTests: [t("alcohol_content"), t("methanol_aldehydes"), t("lab_heavy_metals"), t("lab_food_additives"), t("lab_sulfur_dioxide")],
    ...
    commonRejections: [
      ...
      { problem: t("incorrect_hs_code_classification"), cause: t("gaccRej_hsMisclass"), solution: t("tariff_classification_ruling_before_submission") },
    ],
    marketTrend: 'growing',
  ...
  beverage: {
    ...
    hsRange: "2201-2202",
    isHighRisk: false,
    riskReason: t("gaccProfile_beverage_riskReason"),
    ciqCode: "103",
    ...
    labTests: [t("microbiological_coliforms_pathogens"), t("lab_heavy_metals"), t("lab_food_additives"), t("lab_preservatives")],
  ...
  confectionery: {
    ...
    hsRange: "1704, 1806",
    isHighRisk: false,
    riskReason: t("gaccProfile_water_riskReason"),
    ciqCode: "105",
    ...
    gaccTimelineLow: "3-5 weeks",
    gaccTimelineHigh: "6-10 weeks",
    labTests: [t("lab_microbiological"), t("lab_heavy_metals"), t("lab_food_additives"), t("melamine_for_chocolate_dairy"), t("lab_pesticide_residues")],
  ...
  coffee_tea: {
    ...
    hsRange: "0901-0902",
    isHighRisk: false,
    riskReason: t("gaccProfile_coffee_tea_riskReason"),
    ciqCode: "106",
    chinaTariffRate: "8-15% (MFN)",
    vatRate: "9%",
    consumptionTax: "N/A",
    gaccTimelineLow: "3-5 weeks",
    gaccTimelineHigh: "6-10 weeks",
    labTests: [t("caffeine_content"), t("lab_pesticide_residues"), t("lab_microbiological"), t("lab_heavy_metals"), t("mycotoxins_ochratoxin_a")],
  ...
  canned: {
    ...
    hsRange: "2001-2009",
    isHighRisk: false,
    riskReason: t("gaccProfile_canning_riskReason"),
    ciqCode: "109",
    ...
    gaccTimelineLow: "3-5 weeks",
    gaccTimelineHigh: "6-10 weeks",
    labTests: [t("commercial_sterility"), t("lab_heavy_metals"), t("lab_additives"), t("container_integrity"), t("lab_nutritional_analysis")],
    testCostRange: "$800-2,500",
    commonRejections: [
  ...
  sugar: {
    ...
    hsRange: "1701-1704",
    isHighRisk: false,
    riskReason: t("gaccProfile_condiments_riskReason"),
    ciqCode: "108",
    ...
    gaccTimelineLow: "3-5 weeks",
    gaccTimelineHigh: "6-10 weeks",
    labTests: [t("polarization_sucrose_content"), t("color_value"), t("lab_sulfur_dioxide"), t("lab_heavy_metals")],
  ...
  grain: {
    ...
    labTests: [t("pesticide_residues_multi_residue"), t("mycotoxins_aflatoxin_don_zearalenone"), t("lab_heavy_metals"), t("gmo_testing"), t("pest_quarantine")],
  ...
  meat: {
    ...
    labTests: [t("clenbuterol_β_agonists"), t("lab_heavy_metals"), t("lab_pesticide_residues"), t("hormone_residues"), t("lab_microbiological"), t("species_identification_pcr")],
  ...
  dairy: {
    ...
    labTests: [t("lab_melamine"), t("microbiological_listeria_salmonella"), t("lab_heavy_metals"), t("aflatoxin_m1"), t("antibiotic_residues"), t("nutritional_composition")],
  ...
  honey: {
    ...
    labTests: [t("chloramphenicol_prohibited"), t("nitrofuran_metabolites"), t("tetracycline_antibiotics"), t("lab_heavy_metals"), t("lab_pesticide_residues"), t("c13_sugar_profile_adulteration")],
  ...
  oil: {
    ...
    gaccTimelineLow: "2-4 months",
    gaccTimelineHigh: "5-8 months",
    labTests: [t("benzo_a_pyrene"), t("lab_heavy_metals"), t("acid_value"), t("peroxide_value"), t("lab_pesticide_residues"), t("gmo_testing_for_soybean_corn_oil")],
  ...
  seasoning: {
    ...
    gaccTimelineLow: "2-4 months",
    gaccTimelineHigh: "5-8 months",
    labTests: [t("food_additives_complete_screening"), t("lab_microbiological"), t("lab_heavy_metals"), t("pesticide_residues_multi_herb"), t("lab_mycotoxins")],
  ...
  nuts: {
    ...
    gaccTimelineLow: "2-4 months",
    gaccTimelineHigh: "5-8 months",
    labTests: [t("aflatoxin_b1_total"), t("lab_heavy_metals"), t("lab_pesticide_residues"), t("lab_microbiological"), t("foreign_matter"), t("moisture_content")],
  ...
  health_food: {
    ...
    labTests: [t("active_ingredient_assay"), t("lab_heavy_metals"), t("lab_microbiological"), t("lab_pesticide_residues"), t("lab_stability_testing"), t("disintegration_dissolution")],
...
function getCOUNTRY_DB(t: (key: string) => string): Record<string, CountryProfile> {
  ...
  USA: {
    ...
    ftaWithChina: false,
    ftaDetails: t("fta_usa"),
    specialRestrictions: [t("gaccSpecialRestriction_usa1"), t("gaccSpecialRestriction_usa2")],
    bilateralMeatAccess: true,
    bilateralAquaticAccess: true,
    dairyApproved: true,
    gaccDifficulty: 'moderate',
    languageNote: t("langnote_usa"),
    commonIssues: [t("common_issue_301_tariffs"), t("common_issue_fda_cfda_standards")],
    importVolumeNote: t("import_volume_usa"),
  },
  Canada: {
    region: "North America",
    ftaWithChina: false,
  ...
  Australia: {
    ...
    dairyApproved: true,
    gaccDifficulty: 'moderate',
    languageNote: t("langnote_australia"),
  ...
  NewZealand: {
    ...
    dairyApproved: true,
    gaccDifficulty: 'easy',
    languageNote: t("langnote_newzealand"),
  ...
  Argentina: {
    ...
    dairyApproved: false,
    gaccDifficulty: 'moderate',
    languageNote: t("langnote_argentina"),
  ...
  SouthAfrica: {
    ...
    dairyApproved: false,
    gaccDifficulty: 'moderate',
    languageNote: t("langnote_southafrica"),
    commonIssues: [],
  ...
  Ethiopia: {
    ...
    importVolumeNote: t("import_volume_ethiopia"),
  },
  India: {
    region: "South Asia",
    ftaWithChina: false,
  ...
  Russia: {
    ...
    importVolumeNote: t("import_volume_russia"),
  },
...
function getTimeline(input: GaccInput, catProfiles: Record<GaccCategory, CategoryProfile>, t: (k: string) => string): TimelinePhase[] {
  ...
  return [
    ...
    },
    {
      ...
      responsible: 'Both',
      dependencies: [t("gaccTimelineDep_initAssess")],
    },
    {
      ...
      responsible: 'SinoTrade',
      dependencies: [t("gaccTimelineDep_sampleShipment")],
    },
    {
      ...
      responsible: 'SinoTrade',
      dependencies: [t("gaccTimelineDep_docsReady"), t("gaccTimelineDep_labReportsReceived")],
    },
    {
      ...
      responsible: 'SinoTrade',
      dependencies: [t("gaccTimelineDep_appSubmitted")],
    },
    {
      ...
      responsible: 'SinoTrade',
      dependencies: [t("gaccTimelineDep_productDetailsFinalized")],
    },
    {

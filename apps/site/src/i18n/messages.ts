/**
 * App messages: site + shared UI messages merged.
 * Shared UI messages (Navbar, Footer, Search, CookieConsent, ActionDock)
 * provided by @trade/ui/messages — apps only import their own namespace messages.
 */
